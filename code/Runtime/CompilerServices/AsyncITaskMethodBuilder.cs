namespace RJCP.Runtime.CompilerServices
{
    ...
    /// <summary>
    /// Provides a builder for asynchronous methods that return <see cref="ITask"/>. This type is intended for compiler
    /// use only.
    /// </summary>
    /// <remarks>
    ...
    public struct AsyncITaskMethodBuilder
    {
        ...
        AsyncITaskMethodBuilder(AsyncTaskMethodBuilder builder) : this()
        {
            m_Builder = builder;
        }
        ...
        {
            return new AsyncITaskMethodBuilder(AsyncTaskMethodBuilder.Create());
        }

        /// <summary>
        /// Gets the <see cref="ITask"/> for this builder.
        /// </summary>
        /// <returns>
        /// The <see cref="ITask"/> representing the builder's asynchronous operation.
        /// </returns>
        /// <exception cref="InvalidOperationException">The builder is not initialized.</exception>
        public ITask Task { get { return m_Builder.Task.AsITask(); } }
