namespace RJCP.Threading.Process
{
    ...
    [TestFixture]
    public class RunProcessCmdLineWinTest
    {
        ...
        {
            string[] args = RunProcess.Windows.SplitCommandLine(arguments);
        ...
        {
            string cmdLine = RunProcess.Windows.JoinCommandLine(arguments);
